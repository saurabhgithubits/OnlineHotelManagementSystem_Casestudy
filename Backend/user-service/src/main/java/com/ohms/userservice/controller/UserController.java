package com.ohms.userservice.controller;
...
import com.ohms.userservice.exception.UserNotFoundException;
import com.ohms.userservice.service.impl.UserServiceImpl;
import com.ohms.userservice.util.RoleValidator;
...
@CrossOrigin(origins = {"http://localhost:9091", "http://localhost:4200"}, allowedHeaders = "*")
